...
import { nature_namesUpdateManyWithoutNaturesNestedInput } from '../nature-names/nature-names-update-many-without-natures-nested.input';
...
@InputType()
export class naturesUpdateWithoutContest_types_contest_typesTonatures_hates_flavor_idInput {
    ...
    @Field(() => nature_namesUpdateManyWithoutNaturesNestedInput, {nullable:true})
    nature_names?: nature_namesUpdateManyWithoutNaturesNestedInput;
