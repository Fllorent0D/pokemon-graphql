...
import { naturesUpdateWithoutStats_natures_decreased_stat_idTostatsInput } from './natures-update-without-stats-natures-decreased-stat-id-tostats.input';
...
@InputType()
export class naturesUpsertWithWhereUniqueWithoutStats_natures_decreased_stat_idTostatsInput {

    @Field(() => naturesWhereUniqueInput, {nullable:false})
    @Type(() => naturesWhereUniqueInput)
    where!: naturesWhereUniqueInput;

    @Field(() => naturesUpdateWithoutStats_natures_decreased_stat_idTostatsInput, {nullable:false})
    @Type(() => naturesUpdateWithoutStats_natures_decreased_stat_idTostatsInput)
    update!: naturesUpdateWithoutStats_natures_decreased_stat_idTostatsInput;
