...
import { contest_typesCreateNestedOneWithoutNatures_contest_typesTonatures_likes_flavor_idInput } from '../contest-types/contest-types-create-nested-one-without-natures-contest-types-tonatures-likes-flavor-id.input';
...
@InputType()
export class naturesCreateWithoutContest_types_contest_typesTonatures_hates_flavor_idInput {

    @Field(() => String, {nullable:false})
    identifier!: string;

    @Field(() => contest_typesCreateNestedOneWithoutNatures_contest_typesTonatures_likes_flavor_idInput, {nullable:false})
    contest_types_contest_typesTonatures_likes_flavor_id!: contest_typesCreateNestedOneWithoutNatures_contest_typesTonatures_likes_flavor_idInput;
