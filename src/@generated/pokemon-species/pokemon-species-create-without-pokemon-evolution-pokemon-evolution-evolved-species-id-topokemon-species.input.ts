...
import { pokemon_species_flavor_textCreateNestedManyWithoutPokemon_speciesInput } from '../pokemon-species-flavor-text/pokemon-species-flavor-text-create-nested-many-without-pokemon-species.input';
...
@InputType()
export class pokemon_speciesCreateWithoutPokemon_evolution_pokemon_evolution_evolved_species_idTopokemon_speciesInput {
    ...
    @Field(() => pokemon_species_flavor_textCreateNestedManyWithoutPokemon_speciesInput, {nullable:true})
    pokemon_species_flavor_text?: pokemon_species_flavor_textCreateNestedManyWithoutPokemon_speciesInput;
