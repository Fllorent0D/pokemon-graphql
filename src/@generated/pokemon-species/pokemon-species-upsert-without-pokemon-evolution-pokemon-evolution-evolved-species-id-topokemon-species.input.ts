...
@InputType()
export class pokemon_speciesUpsertWithoutPokemon_evolution_pokemon_evolution_evolved_species_idTopokemon_speciesInput {

    @Field(() => pokemon_speciesUpdateWithoutPokemon_evolution_pokemon_evolution_evolved_species_idTopokemon_speciesInput, {nullable:false})
    ...
    @Field(() => pokemon_speciesCreateWithoutPokemon_evolution_pokemon_evolution_evolved_species_idTopokemon_speciesInput, {nullable:false})
