...
import { pokemon_species_namesUpdateManyWithoutPokemon_speciesNestedInput } from '../pokemon-species-names/pokemon-species-names-update-many-without-pokemon-species-nested.input';
...
@InputType()
export class pokemon_speciesUpdateWithoutPokemon_evolution_pokemon_evolution_evolved_species_idTopokemon_speciesInput {
    ...
    @Field(() => pokemon_species_namesUpdateManyWithoutPokemon_speciesNestedInput, {nullable:true})
    pokemon_species_names?: pokemon_species_namesUpdateManyWithoutPokemon_speciesNestedInput;
