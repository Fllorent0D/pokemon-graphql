...
import { pokemon_habitat_namesUncheckedUpdateManyWithoutLanguagesNestedInput } from '../pokemon-habitat-names/pokemon-habitat-names-unchecked-update-many-without-languages-nested.input';
...
@InputType()
export class languagesUncheckedUpdateWithoutLanguage_names_language_names_local_language_idTolanguagesInput {
    ...
    @Field(() => pokemon_habitat_namesUncheckedUpdateManyWithoutLanguagesNestedInput, {nullable:true})
    pokemon_habitat_names?: pokemon_habitat_namesUncheckedUpdateManyWithoutLanguagesNestedInput;
