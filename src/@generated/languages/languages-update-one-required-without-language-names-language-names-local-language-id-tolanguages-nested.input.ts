...
import { languagesUpsertWithoutLanguage_names_language_names_local_language_idTolanguagesInput } from './languages-upsert-without-language-names-language-names-local-language-id-tolanguages.input';
...
@InputType()
export class languagesUpdateOneRequiredWithoutLanguage_names_language_names_local_language_idTolanguagesNestedInput {
    ...
    @Field(() => languagesUpsertWithoutLanguage_names_language_names_local_language_idTolanguagesInput, {nullable:true})
    @Type(() => languagesUpsertWithoutLanguage_names_language_names_local_language_idTolanguagesInput)
    upsert?: languagesUpsertWithoutLanguage_names_language_names_local_language_idTolanguagesInput;

    @Field(() => languagesWhereUniqueInput, {nullable:true})
    @Type(() => languagesWhereUniqueInput)
    connect?: languagesWhereUniqueInput;

    @Field(() => languagesUpdateWithoutLanguage_names_language_names_local_language_idTolanguagesInput, {nullable:true})
