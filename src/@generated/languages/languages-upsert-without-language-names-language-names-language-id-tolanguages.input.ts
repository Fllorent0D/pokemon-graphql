...
@InputType()
export class languagesUpsertWithoutLanguage_names_language_names_language_idTolanguagesInput {

    @Field(() => languagesUpdateWithoutLanguage_names_language_names_language_idTolanguagesInput, {nullable:false})
