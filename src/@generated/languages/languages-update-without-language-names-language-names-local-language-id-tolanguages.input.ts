...
import { contest_effect_proseUpdateManyWithoutLanguagesNestedInput } from '../contest-effect-prose/contest-effect-prose-update-many-without-languages-nested.input';
...
@InputType()
export class languagesUpdateWithoutLanguage_names_language_names_local_language_idTolanguagesInput {
    ...
    @Field(() => contest_effect_proseUpdateManyWithoutLanguagesNestedInput, {nullable:true})
    contest_effect_prose?: contest_effect_proseUpdateManyWithoutLanguagesNestedInput;
