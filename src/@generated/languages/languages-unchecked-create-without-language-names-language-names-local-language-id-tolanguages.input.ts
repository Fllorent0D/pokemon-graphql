...
import { stat_namesUncheckedCreateNestedManyWithoutLanguagesInput } from '../stat-names/stat-names-unchecked-create-nested-many-without-languages.input';
...
@InputType()
export class languagesUncheckedCreateWithoutLanguage_names_language_names_local_language_idTolanguagesInput {
    ...
    @Field(() => stat_namesUncheckedCreateNestedManyWithoutLanguagesInput, {nullable:true})
    stat_names?: stat_namesUncheckedCreateNestedManyWithoutLanguagesInput;
