...
import { language_namesUpdateWithoutLanguages_language_names_local_language_idTolanguagesInput } from './language-names-update-without-languages-language-names-local-language-id-tolanguages.input';
...
@InputType()
export class language_namesUpsertWithWhereUniqueWithoutLanguages_language_names_local_language_idTolanguagesInput {
    ...
    @Field(() => language_namesUpdateWithoutLanguages_language_names_local_language_idTolanguagesInput, {nullable:false})
    @Type(() => language_namesUpdateWithoutLanguages_language_names_local_language_idTolanguagesInput)
    update!: language_namesUpdateWithoutLanguages_language_names_local_language_idTolanguagesInput;
