...
import { locationsUpsertWithoutPokemon_evolutionInput } from './locations-upsert-without-pokemon-evolution.input';
...
@InputType()
export class locationsUpdateOneWithoutPokemon_evolutionNestedInput {
    ...
    @Field(() => locationsUpsertWithoutPokemon_evolutionInput, {nullable:true})
    @Type(() => locationsUpsertWithoutPokemon_evolutionInput)
    upsert?: locationsUpsertWithoutPokemon_evolutionInput;
    ...
    @Field(() => locationsUpdateWithoutPokemon_evolutionInput, {nullable:true})
