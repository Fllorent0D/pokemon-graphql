...
@InputType()
export class ability_proseScalarWhereWithAggregatesInput {

    @Field(() => [ability_proseScalarWhereWithAggregatesInput], {nullable:true})
    AND?: Array<ability_proseScalarWhereWithAggregatesInput>;

    @Field(() => [ability_proseScalarWhereWithAggregatesInput], {nullable:true})
    OR?: Array<ability_proseScalarWhereWithAggregatesInput>;

    @Field(() => [ability_proseScalarWhereWithAggregatesInput], {nullable:true})
    NOT?: Array<ability_proseScalarWhereWithAggregatesInput>;
