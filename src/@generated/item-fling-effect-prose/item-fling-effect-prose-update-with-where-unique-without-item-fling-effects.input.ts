...
@InputType()
export class item_fling_effect_proseUpdateWithWhereUniqueWithoutItem_fling_effectsInput {
    ...
    data!: item_fling_effect_proseUpdateWithoutItem_fling_effectsInput;
}
