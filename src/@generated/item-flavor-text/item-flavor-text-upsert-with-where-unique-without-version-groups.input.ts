...
@InputType()
export class item_flavor_textUpsertWithWhereUniqueWithoutVersion_groupsInput {
    ...
    update!: item_flavor_textUpdateWithoutVersion_groupsInput;

    @Field(() => item_flavor_textCreateWithoutVersion_groupsInput, {nullable:false})
    @Type(() => item_flavor_textCreateWithoutVersion_groupsInput)
    create!: item_flavor_textCreateWithoutVersion_groupsInput;
}
