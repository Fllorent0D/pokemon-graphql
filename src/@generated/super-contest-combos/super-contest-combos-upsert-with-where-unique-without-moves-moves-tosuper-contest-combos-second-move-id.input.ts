...
@InputType()
export class super_contest_combosUpsertWithWhereUniqueWithoutMoves_movesTosuper_contest_combos_second_move_idInput {
    ...
    update!: super_contest_combosUpdateWithoutMoves_movesTosuper_contest_combos_second_move_idInput;
