...
@InputType()
export class super_contest_combosUpdateWithWhereUniqueWithoutMoves_movesTosuper_contest_combos_first_move_idInput {
    ...
    data!: super_contest_combosUpdateWithoutMoves_movesTosuper_contest_combos_first_move_idInput;
}
