...
import { item_namesUncheckedCreateNestedManyWithoutItemsInput } from '../item-names/item-names-unchecked-create-nested-many-without-items.input';
...
@InputType()
export class itemsUncheckedCreateWithoutPokemon_evolution_itemsTopokemon_evolution_trigger_item_idInput {
    ...
    @Field(() => item_namesUncheckedCreateNestedManyWithoutItemsInput, {nullable:true})
    item_names?: item_namesUncheckedCreateNestedManyWithoutItemsInput;
