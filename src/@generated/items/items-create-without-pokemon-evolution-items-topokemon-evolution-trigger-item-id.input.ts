...
import { item_namesCreateNestedManyWithoutItemsInput } from '../item-names/item-names-create-nested-many-without-items.input';
...
@InputType()
export class itemsCreateWithoutPokemon_evolution_itemsTopokemon_evolution_trigger_item_idInput {
    ...
    @Field(() => item_namesCreateNestedManyWithoutItemsInput, {nullable:true})
    item_names?: item_namesCreateNestedManyWithoutItemsInput;
