...
import { item_flag_mapUpdateManyWithoutItemsNestedInput } from '../item-flag-map/item-flag-map-update-many-without-items-nested.input';
...
@InputType()
export class itemsUpdateWithoutPokemon_evolution_itemsTopokemon_evolution_trigger_item_idInput {
    ...
    @Field(() => item_flag_mapUpdateManyWithoutItemsNestedInput, {nullable:true})
    item_flag_map?: item_flag_mapUpdateManyWithoutItemsNestedInput;
