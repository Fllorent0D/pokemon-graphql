...
import { item_game_indicesUncheckedUpdateManyWithoutItemsNestedInput } from '../item-game-indices/item-game-indices-unchecked-update-many-without-items-nested.input';
...
@InputType()
export class itemsUncheckedUpdateWithoutPokemon_evolution_itemsTopokemon_evolution_trigger_item_idInput {
    ...
    @Field(() => item_game_indicesUncheckedUpdateManyWithoutItemsNestedInput, {nullable:true})
    item_game_indices?: item_game_indicesUncheckedUpdateManyWithoutItemsNestedInput;
