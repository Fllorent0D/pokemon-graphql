...
@InputType()
export class pokemon_form_pokeathlon_statsUpdateWithWhereUniqueWithoutPokeathlon_statsInput {
    ...
    data!: pokemon_form_pokeathlon_statsUpdateWithoutPokeathlon_statsInput;
}
