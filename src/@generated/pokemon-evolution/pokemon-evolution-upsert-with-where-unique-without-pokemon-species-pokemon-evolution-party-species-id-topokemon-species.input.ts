...
@InputType()
export class pokemon_evolutionUpsertWithWhereUniqueWithoutPokemon_species_pokemon_evolution_party_species_idTopokemon_speciesInput {
    ...
    update!: pokemon_evolutionUpdateWithoutPokemon_species_pokemon_evolution_party_species_idTopokemon_speciesInput;
