...
import { pokemon_evolutionUpdateWithoutItems_itemsTopokemon_evolution_held_item_idInput } from './pokemon-evolution-update-without-items-items-topokemon-evolution-held-item-id.input';
...
@InputType()
export class pokemon_evolutionUpsertWithWhereUniqueWithoutItems_itemsTopokemon_evolution_held_item_idInput {
    ...
    @Field(() => pokemon_evolutionUpdateWithoutItems_itemsTopokemon_evolution_held_item_idInput, {nullable:false})
    @Type(() => pokemon_evolutionUpdateWithoutItems_itemsTopokemon_evolution_held_item_idInput)
    update!: pokemon_evolutionUpdateWithoutItems_itemsTopokemon_evolution_held_item_idInput;
