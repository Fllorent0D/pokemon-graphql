...
import { movesUpdateOneWithoutPokemon_evolutionNestedInput } from '../moves/moves-update-one-without-pokemon-evolution-nested.input';
...
@InputType()
export class pokemon_evolutionUpdateWithoutPokemon_species_pokemon_evolution_evolved_species_idTopokemon_speciesInput {
    ...
    @Field(() => movesUpdateOneWithoutPokemon_evolutionNestedInput, {nullable:true})
    moves?: movesUpdateOneWithoutPokemon_evolutionNestedInput;
