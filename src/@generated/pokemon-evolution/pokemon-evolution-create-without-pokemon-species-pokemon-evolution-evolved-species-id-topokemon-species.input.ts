...
import { movesCreateNestedOneWithoutPokemon_evolutionInput } from '../moves/moves-create-nested-one-without-pokemon-evolution.input';
...
@InputType()
export class pokemon_evolutionCreateWithoutPokemon_species_pokemon_evolution_evolved_species_idTopokemon_speciesInput {
    ...
    @Field(() => movesCreateNestedOneWithoutPokemon_evolutionInput, {nullable:true})
    moves?: movesCreateNestedOneWithoutPokemon_evolutionInput;
