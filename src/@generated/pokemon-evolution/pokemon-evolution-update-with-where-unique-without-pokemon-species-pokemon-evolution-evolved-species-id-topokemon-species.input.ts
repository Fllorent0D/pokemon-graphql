...
@InputType()
export class pokemon_evolutionUpdateWithWhereUniqueWithoutPokemon_species_pokemon_evolution_evolved_species_idTopokemon_speciesInput {
    ...
    data!: pokemon_evolutionUpdateWithoutPokemon_species_pokemon_evolution_evolved_species_idTopokemon_speciesInput;
}
