...
@InputType()
export class pokemon_evolutionUpsertWithWhereUniqueWithoutItems_itemsTopokemon_evolution_trigger_item_idInput {
    ...
    update!: pokemon_evolutionUpdateWithoutItems_itemsTopokemon_evolution_trigger_item_idInput;

    @Field(() => pokemon_evolutionCreateWithoutItems_itemsTopokemon_evolution_trigger_item_idInput, {nullable:false})
    @Type(() => pokemon_evolutionCreateWithoutItems_itemsTopokemon_evolution_trigger_item_idInput)
    create!: pokemon_evolutionCreateWithoutItems_itemsTopokemon_evolution_trigger_item_idInput;
}
