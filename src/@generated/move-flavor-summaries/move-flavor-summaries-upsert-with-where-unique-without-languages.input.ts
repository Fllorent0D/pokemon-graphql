...
@InputType()
export class move_flavor_summariesUpsertWithWhereUniqueWithoutLanguagesInput {
    ...
    update!: move_flavor_summariesUpdateWithoutLanguagesInput;

    @Field(() => move_flavor_summariesCreateWithoutLanguagesInput, {nullable:false})
    @Type(() => move_flavor_summariesCreateWithoutLanguagesInput)
    create!: move_flavor_summariesCreateWithoutLanguagesInput;
}
