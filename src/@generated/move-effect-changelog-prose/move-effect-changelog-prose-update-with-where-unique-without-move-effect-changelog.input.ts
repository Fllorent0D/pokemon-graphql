...
@InputType()
export class move_effect_changelog_proseUpdateWithWhereUniqueWithoutMove_effect_changelogInput {
    ...
    data!: move_effect_changelog_proseUpdateWithoutMove_effect_changelogInput;
}
