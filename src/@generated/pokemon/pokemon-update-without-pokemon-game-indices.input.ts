...
import { pokemon_itemsUpdateManyWithoutPokemonNestedInput } from '../pokemon-items/pokemon-items-update-many-without-pokemon-nested.input';
...
@InputType()
export class pokemonUpdateWithoutPokemon_game_indicesInput {
    ...
    @Field(() => pokemon_itemsUpdateManyWithoutPokemonNestedInput, {nullable:true})
    pokemon_items?: pokemon_itemsUpdateManyWithoutPokemonNestedInput;
