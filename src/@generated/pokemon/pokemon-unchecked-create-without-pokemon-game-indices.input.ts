...
import { pokemon_statsUncheckedCreateNestedManyWithoutPokemonInput } from '../pokemon-stats/pokemon-stats-unchecked-create-nested-many-without-pokemon.input';
...
@InputType()
export class pokemonUncheckedCreateWithoutPokemon_game_indicesInput {
    ...
    @Field(() => pokemon_statsUncheckedCreateNestedManyWithoutPokemonInput, {nullable:true})
    pokemon_stats?: pokemon_statsUncheckedCreateNestedManyWithoutPokemonInput;
