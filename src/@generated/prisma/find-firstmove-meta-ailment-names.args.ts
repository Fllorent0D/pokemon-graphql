...
@ArgsType()
export class FindFirstmoveMetaAilmentNamesArgs {
    ...
    @Field(() => [Move_meta_ailment_namesScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Move_meta_ailment_namesScalarFieldEnum>;
}
