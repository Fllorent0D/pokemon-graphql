...
@ArgsType()
export class FindFirstcontestEffectProseArgs {
    ...
    @Field(() => [Contest_effect_proseScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Contest_effect_proseScalarFieldEnum>;
}
