...
@ArgsType()
export class FindFirstmoveBattleStyleProseArgs {
    ...
    @Field(() => [Move_battle_style_proseScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Move_battle_style_proseScalarFieldEnum>;
}
