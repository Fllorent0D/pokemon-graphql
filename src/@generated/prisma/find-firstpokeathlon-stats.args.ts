...
@ArgsType()
export class FindFirstpokeathlonStatsArgs {
    ...
    @Field(() => [Pokeathlon_statsScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Pokeathlon_statsScalarFieldEnum>;
}
