...
@ArgsType()
export class FindFirstpokeathlonStatNamesArgs {
    ...
    @Field(() => [Pokeathlon_stat_namesScalarFieldEnum], {nullable:true})
    distinct?: Array<keyof typeof Pokeathlon_stat_namesScalarFieldEnum>;
}
