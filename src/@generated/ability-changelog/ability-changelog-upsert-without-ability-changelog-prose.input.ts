...
@InputType()
export class ability_changelogUpsertWithoutAbility_changelog_proseInput {

    @Field(() => ability_changelogUpdateWithoutAbility_changelog_proseInput, {nullable:false})
