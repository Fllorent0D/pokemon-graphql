...
import { item_flavor_textCreateNestedManyWithoutVersion_groupsInput } from '../item-flavor-text/item-flavor-text-create-nested-many-without-version-groups.input';
...
@InputType()
export class version_groupsCreateWithoutMove_effect_changelogInput {
    ...
    @Field(() => item_flavor_textCreateNestedManyWithoutVersion_groupsInput, {nullable:true})
    item_flavor_text?: item_flavor_textCreateNestedManyWithoutVersion_groupsInput;
