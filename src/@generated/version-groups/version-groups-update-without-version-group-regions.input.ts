...
import { pokemon_formsUpdateManyWithoutVersion_groupsNestedInput } from '../pokemon-forms/pokemon-forms-update-many-without-version-groups-nested.input';
...
@InputType()
export class version_groupsUpdateWithoutVersion_group_regionsInput {
    ...
    @Field(() => pokemon_formsUpdateManyWithoutVersion_groupsNestedInput, {nullable:true})
    pokemon_forms?: pokemon_formsUpdateManyWithoutVersion_groupsNestedInput;
