...
import { machinesUncheckedCreateNestedManyWithoutVersion_groupsInput } from '../machines/machines-unchecked-create-nested-many-without-version-groups.input';
...
@InputType()
export class version_groupsUncheckedCreateWithoutMove_effect_changelogInput {
    ...
    @Field(() => machinesUncheckedCreateNestedManyWithoutVersion_groupsInput, {nullable:true})
    machines?: machinesUncheckedCreateNestedManyWithoutVersion_groupsInput;
