...
import { move_flavor_textUncheckedUpdateManyWithoutVersion_groupsNestedInput } from '../move-flavor-text/move-flavor-text-unchecked-update-many-without-version-groups-nested.input';
...
@InputType()
export class version_groupsUncheckedUpdateWithoutMove_effect_changelogInput {
    ...
    @Field(() => move_flavor_textUncheckedUpdateManyWithoutVersion_groupsNestedInput, {nullable:true})
    move_flavor_text?: move_flavor_textUncheckedUpdateManyWithoutVersion_groupsNestedInput;
