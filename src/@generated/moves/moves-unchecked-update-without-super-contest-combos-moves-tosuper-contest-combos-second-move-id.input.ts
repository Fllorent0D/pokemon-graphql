...
import { contest_combosUncheckedUpdateManyWithoutMoves_contest_combos_first_move_idTomovesNestedInput } from '../contest-combos/contest-combos-unchecked-update-many-without-moves-contest-combos-first-move-id-tomoves-nested.input';
...
@InputType()
export class movesUncheckedUpdateWithoutSuper_contest_combos_movesTosuper_contest_combos_second_move_idInput {
    ...
    @Field(() => contest_combosUncheckedUpdateManyWithoutMoves_contest_combos_first_move_idTomovesNestedInput, {nullable:true})
    contest_combos_contest_combos_first_move_idTomoves?: contest_combosUncheckedUpdateManyWithoutMoves_contest_combos_first_move_idTomovesNestedInput;
