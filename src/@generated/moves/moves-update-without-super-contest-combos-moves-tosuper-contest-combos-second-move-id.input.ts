...
import { move_flavor_summariesUpdateManyWithoutMovesNestedInput } from '../move-flavor-summaries/move-flavor-summaries-update-many-without-moves-nested.input';
...
@InputType()
export class movesUpdateWithoutSuper_contest_combos_movesTosuper_contest_combos_second_move_idInput {
    ...
    @Field(() => move_flavor_summariesUpdateManyWithoutMovesNestedInput, {nullable:true})
    move_flavor_summaries?: move_flavor_summariesUpdateManyWithoutMovesNestedInput;
