...
@InputType()
export class move_battle_style_proseUpsertWithWhereUniqueWithoutMove_battle_stylesInput {
    ...
    update!: move_battle_style_proseUpdateWithoutMove_battle_stylesInput;
