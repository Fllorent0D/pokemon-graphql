...
import { naturesCreateNestedManyWithoutContest_types_contest_typesTonatures_hates_flavor_idInput } from '../natures/natures-create-nested-many-without-contest-types-contest-types-tonatures-hates-flavor-id.input';

@InputType()
export class contest_typesCreateWithoutNatures_contest_typesTonatures_likes_flavor_idInput {
    ...
    @Field(() => naturesCreateNestedManyWithoutContest_types_contest_typesTonatures_hates_flavor_idInput, {nullable:true})
    natures_contest_typesTonatures_hates_flavor_id?: naturesCreateNestedManyWithoutContest_types_contest_typesTonatures_hates_flavor_idInput;
}
