...
@InputType()
export class contest_typesUpsertWithoutNatures_contest_typesTonatures_likes_flavor_idInput {

    @Field(() => contest_typesUpdateWithoutNatures_contest_typesTonatures_likes_flavor_idInput, {nullable:false})
