...
import { contest_typesUpsertWithoutBerry_flavorsInput } from './contest-types-upsert-without-berry-flavors.input';
...
@InputType()
export class contest_typesUpdateOneRequiredWithoutBerry_flavorsNestedInput {
    ...
    @Field(() => contest_typesUpsertWithoutBerry_flavorsInput, {nullable:true})
    @Type(() => contest_typesUpsertWithoutBerry_flavorsInput)
    upsert?: contest_typesUpsertWithoutBerry_flavorsInput;

    @Field(() => contest_typesWhereUniqueInput, {nullable:true})
    @Type(() => contest_typesWhereUniqueInput)
    connect?: contest_typesWhereUniqueInput;

    @Field(() => contest_typesUpdateWithoutBerry_flavorsInput, {nullable:true})
