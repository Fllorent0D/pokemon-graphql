...
import { pokemon_species_flavor_summariesUpdateWithoutPokemon_speciesInput } from './pokemon-species-flavor-summaries-update-without-pokemon-species.input';
...
@InputType()
export class pokemon_species_flavor_summariesUpsertWithWhereUniqueWithoutPokemon_speciesInput {
    ...
    @Field(() => pokemon_species_flavor_summariesUpdateWithoutPokemon_speciesInput, {nullable:false})
    @Type(() => pokemon_species_flavor_summariesUpdateWithoutPokemon_speciesInput)
    update!: pokemon_species_flavor_summariesUpdateWithoutPokemon_speciesInput;
