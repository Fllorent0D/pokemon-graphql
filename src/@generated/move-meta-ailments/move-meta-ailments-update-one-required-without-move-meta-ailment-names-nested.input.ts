...
import { move_meta_ailmentsUpsertWithoutMove_meta_ailment_namesInput } from './move-meta-ailments-upsert-without-move-meta-ailment-names.input';
...
@InputType()
export class move_meta_ailmentsUpdateOneRequiredWithoutMove_meta_ailment_namesNestedInput {
    ...
    @Field(() => move_meta_ailmentsUpsertWithoutMove_meta_ailment_namesInput, {nullable:true})
    @Type(() => move_meta_ailmentsUpsertWithoutMove_meta_ailment_namesInput)
    upsert?: move_meta_ailmentsUpsertWithoutMove_meta_ailment_namesInput;
    ...
    @Field(() => move_meta_ailmentsUpdateWithoutMove_meta_ailment_namesInput, {nullable:true})
