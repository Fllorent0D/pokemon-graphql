...
@InputType()
export class move_meta_category_proseUpsertWithWhereUniqueWithoutMove_meta_categoriesInput {
    ...
    update!: move_meta_category_proseUpdateWithoutMove_meta_categoriesInput;
