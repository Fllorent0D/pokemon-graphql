...
@InputType()
export class typesUpsertWithoutType_efficacy_type_efficacy_target_type_idTotypesInput {

    @Field(() => typesUpdateWithoutType_efficacy_type_efficacy_target_type_idTotypesInput, {nullable:false})
