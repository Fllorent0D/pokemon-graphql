...
import { movesCreateNestedManyWithoutTypesInput } from '../moves/moves-create-nested-many-without-types.input';
...
@InputType()
export class typesCreateWithoutType_efficacy_type_efficacy_damage_type_idTotypesInput {
    ...
    @Field(() => movesCreateNestedManyWithoutTypesInput, {nullable:true})
    moves?: movesCreateNestedManyWithoutTypesInput;
