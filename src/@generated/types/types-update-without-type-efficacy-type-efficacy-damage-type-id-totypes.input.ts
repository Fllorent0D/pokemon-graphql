...
import { move_damage_classesUpdateOneWithoutTypesNestedInput } from '../move-damage-classes/move-damage-classes-update-one-without-types-nested.input';
...
@InputType()
export class typesUpdateWithoutType_efficacy_type_efficacy_damage_type_idTotypesInput {

    @Field(() => StringFieldUpdateOperationsInput, {nullable:true})
    identifier?: StringFieldUpdateOperationsInput;

    @Field(() => move_damage_classesUpdateOneWithoutTypesNestedInput, {nullable:true})
    move_damage_classes?: move_damage_classesUpdateOneWithoutTypesNestedInput;
