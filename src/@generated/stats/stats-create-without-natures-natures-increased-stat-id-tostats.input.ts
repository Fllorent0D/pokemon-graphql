...
import { naturesCreateNestedManyWithoutStats_natures_decreased_stat_idTostatsInput } from '../natures/natures-create-nested-many-without-stats-natures-decreased-stat-id-tostats.input';
...
@InputType()
export class statsCreateWithoutNatures_natures_increased_stat_idTostatsInput {
    ...
    @Field(() => naturesCreateNestedManyWithoutStats_natures_decreased_stat_idTostatsInput, {nullable:true})
    natures_natures_decreased_stat_idTostats?: naturesCreateNestedManyWithoutStats_natures_decreased_stat_idTostatsInput;
