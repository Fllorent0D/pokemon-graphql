...
@InputType()
export class statsUpsertWithoutNatures_natures_decreased_stat_idTostatsInput {

    @Field(() => statsUpdateWithoutNatures_natures_decreased_stat_idTostatsInput, {nullable:false})
    ...
    @Field(() => statsCreateWithoutNatures_natures_decreased_stat_idTostatsInput, {nullable:false})
