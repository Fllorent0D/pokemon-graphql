...
@InputType()
export class move_meta_ailment_namesUpsertWithWhereUniqueWithoutMove_meta_ailmentsInput {
    ...
    update!: move_meta_ailment_namesUpdateWithoutMove_meta_ailmentsInput;
