...
@InputType()
export class contest_combosUpsertWithWhereUniqueWithoutMoves_contest_combos_first_move_idTomovesInput {
    ...
    update!: contest_combosUpdateWithoutMoves_contest_combos_first_move_idTomovesInput;
