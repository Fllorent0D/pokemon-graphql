...
@InputType()
export class contest_combosOrderByWithRelationInput {
    ...
    moves_contest_combos_second_move_idTomoves?: movesOrderByWithRelationInput;

    @Field(() => movesOrderByWithRelationInput, {nullable:true})
    moves_contest_combos_first_move_idTomoves?: movesOrderByWithRelationInput;
}
