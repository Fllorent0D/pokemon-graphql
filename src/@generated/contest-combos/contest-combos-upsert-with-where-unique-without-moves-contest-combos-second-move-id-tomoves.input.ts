...
import { contest_combosUpdateWithoutMoves_contest_combos_second_move_idTomovesInput } from './contest-combos-update-without-moves-contest-combos-second-move-id-tomoves.input';
...
@InputType()
export class contest_combosUpsertWithWhereUniqueWithoutMoves_contest_combos_second_move_idTomovesInput {
    ...
    @Field(() => contest_combosUpdateWithoutMoves_contest_combos_second_move_idTomovesInput, {nullable:false})
    @Type(() => contest_combosUpdateWithoutMoves_contest_combos_second_move_idTomovesInput)
    update!: contest_combosUpdateWithoutMoves_contest_combos_second_move_idTomovesInput;
