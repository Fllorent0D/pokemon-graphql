...
import { move_flagsUpsertWithoutMove_flag_proseInput } from './move-flags-upsert-without-move-flag-prose.input';
...
@InputType()
export class move_flagsUpdateOneRequiredWithoutMove_flag_proseNestedInput {
    ...
    @Field(() => move_flagsUpsertWithoutMove_flag_proseInput, {nullable:true})
    @Type(() => move_flagsUpsertWithoutMove_flag_proseInput)
    upsert?: move_flagsUpsertWithoutMove_flag_proseInput;

    @Field(() => move_flagsWhereUniqueInput, {nullable:true})
    @Type(() => move_flagsWhereUniqueInput)
    connect?: move_flagsWhereUniqueInput;

    @Field(() => move_flagsUpdateWithoutMove_flag_proseInput, {nullable:true})
