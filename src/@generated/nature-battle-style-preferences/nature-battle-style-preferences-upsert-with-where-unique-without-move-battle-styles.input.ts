...
@InputType()
export class nature_battle_style_preferencesUpsertWithWhereUniqueWithoutMove_battle_stylesInput {
    ...
    update!: nature_battle_style_preferencesUpdateWithoutMove_battle_stylesInput;
