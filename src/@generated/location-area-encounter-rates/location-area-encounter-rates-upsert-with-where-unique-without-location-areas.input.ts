...
@InputType()
export class location_area_encounter_ratesUpsertWithWhereUniqueWithoutLocation_areasInput {
    ...
    update!: location_area_encounter_ratesUpdateWithoutLocation_areasInput;
