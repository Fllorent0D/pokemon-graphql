...
import { typesUpdateManyWithoutGenerationsNestedInput } from '../types/types-update-many-without-generations-nested.input';
...
@InputType()
export class generationsUpdateWithoutLocation_game_indicesInput {
    ...
    @Field(() => typesUpdateManyWithoutGenerationsNestedInput, {nullable:true})
    types?: typesUpdateManyWithoutGenerationsNestedInput;
