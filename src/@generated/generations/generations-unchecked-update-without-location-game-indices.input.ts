...
import { abilitiesUncheckedUpdateManyWithoutGenerationsNestedInput } from '../abilities/abilities-unchecked-update-many-without-generations-nested.input';
...
@InputType()
export class generationsUncheckedUpdateWithoutLocation_game_indicesInput {
    ...
    @Field(() => abilitiesUncheckedUpdateManyWithoutGenerationsNestedInput, {nullable:true})
    abilities?: abilitiesUncheckedUpdateManyWithoutGenerationsNestedInput;
